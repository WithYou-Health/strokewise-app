    ...
    <div style={{minHeight:"100vh",background:BG,fontFamily:"Georgia,serif",color:NAVY,position:"relative",overflowX:"hidden"}}>
      ...
      {onboarded&&(
        <>
          ...
          {/* Premium Modal */}
          {modal&&(
            <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",backdropFilter:"blur(8px)",display:"flex",alignItems:"flex-start",justifyContent:"center",padding:"60px 20px 20px",zIndex:200}} onClick={()=>setModal(false)}>
              <div style={{background:"linear-gradient(160deg,#fff,#f8f4ef)",borderRadius:26,padding:"28px 24px 36px",width:"100%",maxWidth:480,border:"1px solid rgba(30,58,95,0.1)",boxSizing:"border-box",maxHeight:"85vh",overflowY:"auto"}} onClick={e=>e.stopPropagation()}>
                <div style={{display:"flex",justifyContent:"center",gap:6,marginBottom:16,flexWrap:"wrap"}}>
