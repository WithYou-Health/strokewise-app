...
const CBN_PALETTE = [
  ...
  {num:3,  color:"#eab308", name:"Yellow"   },
  {num:4,  color:"#4ade80", name:"Green"    },
  {num:5,  color:"#60a5fa", name:"Blue"     },
  {num:6,  color:"#a78bfa", name:"Purple"   },
  {num:7,  color:"#f472b6", name:"Pink"     },
  {num:8,  color:"#fde68a", name:"Cream"    },
  {num:9,  color:"#d4a574", name:"Tan"      },
  {num:10, color:"#92400e", name:"Brown"    },
  {num:11, color:"#ffffff", name:"White"    },
  {num:12, color:"#9ca3af", name:"Grey"     },
  {num:13, color:"#166534", name:"Dk Green" },
...
const CBN_SCENES = [
  {
    ...
    sections:[
      {id:1,label:"Sky",cx:30,cy:30},{id:2,label:"Grass",cx:140,cy:265},{id:3,label:"Body",cx:140,cy:188},
      {id:4,label:"Left Ear",cx:88,cy:80},{id:5,label:"Right Ear",cx:192,cy:80},{id:6,label:"L Ear Inner",cx:88,cy:68},
      {id:7,label:"R Ear Inner",cx:192,cy:68},{id:8,label:"Head",cx:140,cy:106},{id:9,label:"Nose",cx:140,cy:108},
      {id:10,label:"Left Eye",cx:113,cy:96},{id:11,label:"Right Eye",cx:167,cy:96},{id:12,label:"L Pupil",cx:113,cy:96},
      {id:13,label:"R Pupil",cx:167,cy:96},{id:14,label:"Collar",cx:140,cy:150},{id:15,label:"Tag",cx:140,cy:161},
      {id:16,label:"Tongue",cx:140,cy:130},{id:17,label:"Left Leg",cx:100,cy:238},{id:18,label:"Right Leg",cx:180,cy:238},
    ],
    render(c) {
      return (
        <>
          ...
          <ellipse cx="140" cy="188" rx="64" ry="52" fill={c(3)} stroke={NAVY} strokeWidth="1.5" />
          <ellipse cx="88" cy="82" rx="22" ry="32" fill={c(4)} stroke={NAVY} strokeWidth="1.5" />
          <ellipse cx="192" cy="82" rx="22" ry="32" fill={c(5)} stroke={NAVY} strokeWidth="1.5" />
          <ellipse cx="88" cy="70" rx="13" ry="18" fill={c(6)} />
          <ellipse cx="192" cy="70" rx="13" ry="18" fill={c(7)} />
          <circle cx="140" cy="107" r="54" fill={c(8)} stroke={NAVY} strokeWidth="1.5" />
          <ellipse cx="140" cy="119" rx="26" ry="17" fill={c(8)} stroke={NAVY} strokeWidth="1" />
          <ellipse cx="140" cy="110" rx="10" ry="7" fill={c(9)} stroke={NAVY} strokeWidth="1" />
          <circle cx="136" cy="109" r="2" fill="rgba(0,0,0,0.3)" /><circle cx="144" cy="109" r="2" fill="rgba(0,0,0,0.3)" />
          <circle cx="113" cy="97" r="10" fill={c(10)} stroke={NAVY} strokeWidth="1.2" />
          <circle cx="167" cy="97" r="10" fill={c(11)} stroke={NAVY} strokeWidth="1.2" />
          <circle cx="113" cy="97" r="5" fill={c(12)} /><circle cx="167" cy="97" r="5" fill={c(13)} />
          <circle cx="116" cy="94" r="2" fill="white" /><circle cx="170" cy="94" r="2" fill="white" />
          <rect x="93" y="143" width="94" height="16" rx="8" fill={c(14)} stroke={NAVY} strokeWidth="1.2" />
          <circle cx="140" cy="162" r="8" fill={c(15)} stroke={NAVY} strokeWidth="1" />
          <ellipse cx="140" cy="130" rx="12" ry="10" fill={c(16)} stroke={NAVY} strokeWidth="1" />
          <path d="M 127,127 Q 140,135 153,127" fill="none" stroke={NAVY} strokeWidth="1.5" strokeLinecap="round" />
        </>
      );
    }
  },
  {
    ...
    sections:[
      {id:1,label:"Sky",cx:30,cy:30},{id:2,label:"Grass",cx:140,cy:265},{id:3,label:"Body",cx:140,cy:188},
      {id:4,label:"Left Ear",cx:92,cy:60},{id:5,label:"Right Ear",cx:188,cy:60},{id:6,label:"Inn L Ear",cx:92,cy:62},
      {id:7,label:"Inn R Ear",cx:188,cy:62},{id:8,label:"Head",cx:140,cy:105},{id:9,label:"Nose",cx:140,cy:109},
      {id:10,label:"Left Eye",cx:112,cy:96},{id:11,label:"Right Eye",cx:168,cy:96},{id:12,label:"L Pupil",cx:112,cy:96},
      {id:13,label:"R Pupil",cx:168,cy:96},{id:14,label:"Left Paw",cx:100,cy:240},{id:15,label:"Right Paw",cx:180,cy:240},
      {id:16,label:"Tail",cx:216,cy:178},
    ],
    render(c) {
      return (
        <>
          <rect x="0" y="0" width="280" height="280" fill={c(1)} />
          <ellipse cx="140" cy="270" rx="140" ry="18" fill={c(2)} /><rect x="0" y="258" width="280" height="22" fill={c(2)} />
          <ellipse cx="216" cy="180" rx="28" ry="14" fill={c(16)} stroke={NAVY} strokeWidth="1.5" transform="rotate(-25,216,180)" />
          <rect x="86" y="214" width="28" height="44" rx="12" fill={c(14)} stroke={NAVY} strokeWidth="1.5" />
          <rect x="166" y="214" width="28" height="44" rx="12" fill={c(15)} stroke={NAVY} strokeWidth="1.5" />
          <ellipse cx="95" cy="256" rx="5" ry="3" fill={c(14)} stroke={NAVY} strokeWidth="0.8" />
          <ellipse cx="100" cy="258" rx="5" ry="3" fill={c(14)} stroke={NAVY} strokeWidth="0.8" />
          <ellipse cx="105" cy="256" rx="5" ry="3" fill={c(14)} stroke={NAVY} strokeWidth="0.8" />
          <ellipse cx="175" cy="256" rx="5" ry="3" fill={c(15)} stroke={NAVY} strokeWidth="0.8" />
          <ellipse cx="180" cy="258" rx="5" ry="3" fill={c(15)} stroke={NAVY} strokeWidth="0.8" />
          <ellipse cx="185" cy="256" rx="5" ry="3" fill={c(15)} stroke={NAVY} strokeWidth="0.8" />
          <ellipse cx="140" cy="188" rx="60" ry="50" fill={c(3)} stroke={NAVY} strokeWidth="1.5" />
          <path d="M 108,174 Q 140,168 172,174" fill="none" stroke="rgba(180,140,90,0.45)" strokeWidth="5" strokeLinecap="round" />
          <path d="M 104,188 Q 140,182 176,188" fill="none" stroke="rgba(180,140,90,0.45)" strokeWidth="5" strokeLinecap="round" />
          <path d="M 108,202 Q 140,196 172,202" fill="none" stroke="rgba(180,140,90,0.45)" strokeWidth="5" strokeLinecap="round" />
          <polygon points="78,92 70,40 118,70" fill={c(4)} stroke={NAVY} strokeWidth="1.5" strokeLinejoin="round" />
          <polygon points="202,92 210,40 162,70" fill={c(5)} stroke={NAVY} strokeWidth="1.5" strokeLinejoin="round" />
          <polygon points="82,86 76,48 112,68" fill={c(6)} />
          <polygon points="198,86 204,48 168,68" fill={c(7)} />
          <circle cx="140" cy="106" r="54" fill={c(8)} stroke={NAVY} strokeWidth="1.5" />
          <ellipse cx="108" cy="120" rx="16" ry="10" fill="rgba(244,114,182,0.18)" />
          <ellipse cx="172" cy="120" rx="16" ry="10" fill="rgba(244,114,182,0.18)" />
          <polygon points="140,103 134,112 146,112" fill={c(9)} stroke={NAVY} strokeWidth="1" strokeLinejoin="round" />
          <ellipse cx="112" cy="97" rx="11" ry="10" fill={c(10)} stroke={NAVY} strokeWidth="1.2" />
          <ellipse cx="168" cy="97" rx="11" ry="10" fill={c(11)} stroke={NAVY} strokeWidth="1.2" />
          <ellipse cx="112" cy="97" rx="4" ry="9" fill={c(12)} />
          <ellipse cx="168" cy="97" rx="4" ry="9" fill={c(13)} />
          <circle cx="115" cy="93" r="2" fill="white" /><circle cx="171" cy="93" r="2" fill="white" />
          <line x1="86" y1="113" x2="126" y2="117" stroke={NAVY} strokeWidth="1" opacity="0.45" />
          <line x1="86" y1="121" x2="126" y2="121" stroke={NAVY} strokeWidth="1" opacity="0.45" />
          <line x1="154" y1="117" x2="194" y2="113" stroke={NAVY} strokeWidth="1" opacity="0.45" />
          <line x1="154" y1="121" x2="194" y2="121" stroke={NAVY} strokeWidth="1" opacity="0.45" />
          <path d="M 133,114 Q 140,121 147,114" fill="none" stroke={NAVY} strokeWidth="1.5" strokeLinecap="round" />
        </>
      );
    }
  },
  {
    ...
    sections:[
      {id:1,label:"Sky",cx:30,cy:30},{id:2,label:"Grass",cx:140,cy:265},{id:3,label:"Stem",cx:140,cy:200},
      {id:4,label:"Left Leaf",cx:106,cy:192},{id:5,label:"Right Leaf",cx:174,cy:192},{id:6,label:"Top Petal",cx:140,cy:66},
      {id:7,label:"Bot Petal",cx:140,cy:152},{id:8,label:"Left Petal",cx:74,cy:109},{id:9,label:"Right Petal",cx:206,cy:109},
      {id:10,label:"Top-L Petal",cx:94,cy:78},{id:11,label:"Top-R Petal",cx:186,cy:78},{id:12,label:"Bot-L Petal",cx:94,cy:140},
      {id:13,label:"Bot-R Petal",cx:186,cy:140},{id:14,label:"Centre",cx:140,cy:109},{id:15,label:"Centre Dot",cx:140,cy:109},
    ],
    render(c) {
      return (
        <>
          ...
          <ellipse cx="206" cy="109" rx="36" ry="18" fill={c(9)} stroke={NAVY} strokeWidth="1.2" />
          <ellipse cx="94" cy="78" rx="24" ry="24" fill={c(10)} stroke={NAVY} strokeWidth="1.2" transform="rotate(-45,94,78)" />
          <ellipse cx="186" cy="78" rx="24" ry="24" fill={c(11)} stroke={NAVY} strokeWidth="1.2" transform="rotate(45,186,78)" />
          <ellipse cx="94" cy="140" rx="24" ry="24" fill={c(12)} stroke={NAVY} strokeWidth="1.2" transform="rotate(45,94,140)" />
  ...
  },
  {
    ...
    sections:[
      {id:1,label:"Sky",cx:30,cy:30},{id:2,label:"Grass",cx:140,cy:265},{id:3,label:"Stem",cx:140,cy:210},
      {id:4,label:"Left Leaf",cx:100,cy:198},{id:5,label:"Right Leaf",cx:180,cy:198},{id:6,label:"Outer Petal L",cx:108,cy:118},
      {id:7,label:"Outer Petal R",cx:172,cy:118},{id:8,label:"Top Petal",cx:140,cy:80},{id:9,label:"Mid Petal L",cx:116,cy:108},
      {id:10,label:"Mid Petal R",cx:164,cy:108},{id:11,label:"Inner Petal",cx:140,cy:98},{id:12,label:"Centre",cx:140,cy:105},
      {id:13,label:"Thorns",cx:155,cy:175},{id:14,label:"Sepal",cx:140,cy:140},
    ],
    render(c) {
      return (
        <>
          <rect x="0" y="0" width="280" height="280" fill={c(1)} />
          <ellipse cx="140" cy="270" rx="140" ry="18" fill={c(2)} /><rect x="0" y="258" width="280" height="22" fill={c(2)} />
          <rect x="135" y="148" width="10" height="118" rx="5" fill={c(3)} stroke={NAVY} strokeWidth="1" />
          <ellipse cx="100" cy="200" rx="34" ry="13" fill={c(4)} stroke={NAVY} strokeWidth="1" transform="rotate(-25,100,200)" />
          <ellipse cx="180" cy="200" rx="34" ry="13" fill={c(5)} stroke={NAVY} strokeWidth="1" transform="rotate(25,180,200)" />
          <polygon points="148,172 155,162 162,172" fill={c(13)} />
          <polygon points="155,185 162,175 169,185" fill={c(13)} />
          <ellipse cx="140" cy="140" rx="22" ry="12" fill={c(14)} stroke={NAVY} strokeWidth="1" />
          <ellipse cx="108" cy="120" rx="28" ry="38" fill={c(6)} stroke={NAVY} strokeWidth="1.2" />
          <ellipse cx="172" cy="120" rx="28" ry="38" fill={c(7)} stroke={NAVY} strokeWidth="1.2" />
          <ellipse cx="140" cy="82" rx="32" ry="28" fill={c(8)} stroke={NAVY} strokeWidth="1.2" />
          <ellipse cx="116" cy="110" rx="22" ry="30" fill={c(9)} stroke={NAVY} strokeWidth="1.2" />
          <ellipse cx="164" cy="110" rx="22" ry="30" fill={c(10)} stroke={NAVY} strokeWidth="1.2" />
          <ellipse cx="140" cy="100" rx="20" ry="24" fill={c(11)} stroke={NAVY} strokeWidth="1.2" />
          <ellipse cx="140" cy="108" rx="12" ry="14" fill={c(12)} stroke={NAVY} strokeWidth="1" />
        </>
      );
    }
  },
  {
    ...
    sections:[
      {id:1,label:"Sky",cx:30,cy:30},{id:2,label:"Grass",cx:140,cy:265},{id:3,label:"Stem",cx:140,cy:210},
      {id:4,label:"Left Leaf",cx:104,cy:200},{id:5,label:"Right Leaf",cx:176,cy:200},{id:6,label:"Top Petal",cx:140,cy:56},
      {id:7,label:"Bot Petal",cx:140,cy:162},{id:8,label:"Left Petal",cx:56,cy:109},{id:9,label:"Right Petal",cx:224,cy:109},
      {id:10,label:"Top-L Petal",cx:88,cy:72},{id:11,label:"Top-R Petal",cx:192,cy:72},{id:12,label:"Bot-L Petal",cx:88,cy:146},
      {id:13,label:"Bot-R Petal",cx:192,cy:146},{id:14,label:"Centre",cx:140,cy:109},{id:15,label:"Centre Dark",cx:140,cy:109},
    ],
    render(c) {
      return (
        <>
          <rect x="0" y="0" width="280" height="280" fill={c(1)} />
          <ellipse cx="140" cy="270" rx="140" ry="18" fill={c(2)} /><rect x="0" y="258" width="280" height="22" fill={c(2)} />
          <rect x="134" y="155" width="12" height="108" rx="6" fill={c(3)} stroke={NAVY} strokeWidth="1" />
          <ellipse cx="104" cy="202" rx="34" ry="13" fill={c(4)} stroke={NAVY} strokeWidth="1" transform="rotate(-20,104,202)" />
          <ellipse cx="176" cy="202" rx="34" ry="13" fill={c(5)} stroke={NAVY} strokeWidth="1" transform="rotate(20,176,202)" />
          <ellipse cx="140" cy="58" rx="16" ry="34" fill={c(6)} stroke={NAVY} strokeWidth="1.2" />
          <ellipse cx="140" cy="160" rx="16" ry="34" fill={c(7)} stroke={NAVY} strokeWidth="1.2" />
          <ellipse cx="58" cy="109" rx="34" ry="16" fill={c(8)} stroke={NAVY} strokeWidth="1.2" />
          <ellipse cx="222" cy="109" rx="34" ry="16" fill={c(9)} stroke={NAVY} strokeWidth="1.2" />
          <ellipse cx="88" cy="72" rx="22" ry="22" fill={c(10)} stroke={NAVY} strokeWidth="1.2" transform="rotate(-45,88,72)" />
          <ellipse cx="192" cy="72" rx="22" ry="22" fill={c(11)} stroke={NAVY} strokeWidth="1.2" transform="rotate(45,192,72)" />
          <ellipse cx="88" cy="146" rx="22" ry="22" fill={c(12)} stroke={NAVY} strokeWidth="1.2" transform="rotate(45,88,146)" />
          <ellipse cx="192" cy="146" rx="22" ry="22" fill={c(13)} stroke={NAVY} strokeWidth="1.2" transform="rotate(-45,192,146)" />
          <circle cx="140" cy="109" r="38" fill={c(14)} stroke={NAVY} strokeWidth="1.5" />
          <circle cx="140" cy="109" r="24" fill={c(15)} stroke={NAVY} strokeWidth="1" />
          <circle cx="132" cy="101" r="3" fill="rgba(0,0,0,0.2)" /><circle cx="140" cy="99" r="3" fill="rgba(0,0,0,0.2)" />
          <circle cx="148" cy="101" r="3" fill="rgba(0,0,0,0.2)" /><circle cx="130" cy="109" r="3" fill="rgba(0,0,0,0.2)" />
          <circle cx="150" cy="109" r="3" fill="rgba(0,0,0,0.2)" /><circle cx="132" cy="117" r="3" fill="rgba(0,0,0,0.2)" />
          <circle cx="140" cy="119" r="3" fill="rgba(0,0,0,0.2)" /><circle cx="148" cy="117" r="3" fill="rgba(0,0,0,0.2)" />
        </>
      );
    }
  },
  {
    ...
    sections:[
      {id:1,label:"Sky",cx:30,cy:30},{id:2,label:"Grass",cx:140,cy:265},{id:3,label:"Stem",cx:140,cy:210},
      {id:4,label:"Left Leaf",cx:106,cy:200},{id:5,label:"Right Leaf",cx:174,cy:200},{id:6,label:"Top Petal",cx:140,cy:62},
      {id:7,label:"Bot Petal",cx:140,cy:156},{id:8,label:"Left Petal",cx:70,cy:109},{id:9,label:"Right Petal",cx:210,cy:109},
      {id:10,label:"Top-L Petal",cx:90,cy:74},{id:11,label:"Top-R Petal",cx:190,cy:74},{id:12,label:"Bot-L Petal",cx:90,cy:144},
      {id:13,label:"Bot-R Petal",cx:190,cy:144},{id:14,label:"Centre",cx:140,cy:109},{id:15,label:"Centre Dot",cx:140,cy:109},
    ],
    render(c) {
      return (
        <>
          <rect x="0" y="0" width="280" height="280" fill={c(1)} />
          <ellipse cx="140" cy="270" rx="140" ry="18" fill={c(2)} /><rect x="0" y="258" width="280" height="22" fill={c(2)} />
          <rect x="134" y="148" width="12" height="116" rx="6" fill={c(3)} stroke={NAVY} strokeWidth="1" />
          <ellipse cx="106" cy="202" rx="34" ry="13" fill={c(4)} stroke={NAVY} strokeWidth="1" transform="rotate(-22,106,202)" />
          <ellipse cx="174" cy="202" rx="34" ry="13" fill={c(5)} stroke={NAVY} strokeWidth="1" transform="rotate(22,174,202)" />
          <ellipse cx="140" cy="64" rx="14" ry="38" fill={c(6)} stroke={NAVY} strokeWidth="1.2" />
          <ellipse cx="140" cy="154" rx="14" ry="38" fill={c(7)} stroke={NAVY} strokeWidth="1.2" />
          <ellipse cx="72" cy="109" rx="38" ry="14" fill={c(8)} stroke={NAVY} strokeWidth="1.2" />
          <ellipse cx="208" cy="109" rx="38" ry="14" fill={c(9)} stroke={NAVY} strokeWidth="1.2" />
          <ellipse cx="90" cy="74" rx="20" ry="20" fill={c(10)} stroke={NAVY} strokeWidth="1.2" transform="rotate(-45,90,74)" />
          <ellipse cx="190" cy="74" rx="20" ry="20" fill={c(11)} stroke={NAVY} strokeWidth="1.2" transform="rotate(45,190,74)" />
          <ellipse cx="90" cy="144" rx="20" ry="20" fill={c(12)} stroke={NAVY} strokeWidth="1.2" transform="rotate(45,90,144)" />
          <ellipse cx="190" cy="144" rx="20" ry="20" fill={c(13)} stroke={NAVY} strokeWidth="1.2" transform="rotate(-45,190,144)" />
          <circle cx="140" cy="109" r="30" fill={c(14)} stroke={NAVY} strokeWidth="1.5" />
          <circle cx="140" cy="109" r="14" fill={c(15)} stroke={NAVY} strokeWidth="1" />
        </>
      );
    }
  },
  {
    ...
    sections:[
      {id:1,label:"Sky",cx:30,cy:30},{id:2,label:"Grass",cx:140,cy:265},{id:3,label:"Body",cx:140,cy:155},
      {id:4,label:"Wing",cx:158,cy:148},{id:5,label:"Breast",cx:126,cy:148},{id:6,label:"Head",cx:130,cy:98},
      {id:7,label:"Eye",cx:122,cy:91},{id:8,label:"Eye Dot",cx:122,cy:91},{id:9,label:"Eye Ring",cx:122,cy:91},
      {id:10,label:"Beak Top",cx:108,cy:96},{id:11,label:"Beak Bot",cx:108,cy:102},{id:12,label:"Tail",cx:168,cy:178},
      {id:13,label:"Left Leg",cx:128,cy:215},{id:14,label:"Right Leg",cx:152,cy:215},
    ],
    render(c) {
      return (
        <>
          <rect x="0" y="0" width="280" height="280" fill={c(1)} />
          <ellipse cx="140" cy="270" rx="140" ry="18" fill={c(2)} /><rect x="0" y="258" width="280" height="22" fill={c(2)} />
          <line x1="128" y1="205" x2="122" y2="230" stroke={c(13)} strokeWidth="4" strokeLinecap="round" />
          <line x1="122" y1="230" x2="112" y2="234" stroke={c(13)} strokeWidth="3" strokeLinecap="round" />
          <line x1="122" y1="230" x2="118" y2="238" stroke={c(13)} strokeWidth="3" strokeLinecap="round" />
          <line x1="152" y1="205" x2="158" y2="230" stroke={c(14)} strokeWidth="4" strokeLinecap="round" />
          <line x1="158" y1="230" x2="168" y2="234" stroke={c(14)} strokeWidth="3" strokeLinecap="round" />
          <line x1="158" y1="230" x2="162" y2="238" stroke={c(14)} strokeWidth="3" strokeLinecap="round" />
          <ellipse cx="162" cy="178" rx="18" ry="28" fill={c(12)} stroke={NAVY} strokeWidth="1" transform="rotate(15,162,178)" />
          <ellipse cx="140" cy="158" rx="44" ry="52" fill={c(3)} stroke={NAVY} strokeWidth="1.5" />
          <ellipse cx="160" cy="150" rx="30" ry="42" fill={c(4)} stroke={NAVY} strokeWidth="1" transform="rotate(10,160,150)" />
          <ellipse cx="122" cy="150" rx="26" ry="36" fill={c(5)} stroke={NAVY} strokeWidth="1.2" />
          <circle cx="130" cy="100" r="34" fill={c(6)} stroke={NAVY} strokeWidth="1.5" />
          <circle cx="122" cy="91" r="10" fill={c(7)} stroke={NAVY} strokeWidth="1" />
          <circle cx="122" cy="91" r="6" fill={c(8)} />
          <circle cx="122" cy="91" r="3" fill="white" />
          <polygon points="95,93 112,90 95,99" fill={c(10)} stroke={NAVY} strokeWidth="0.8" />
          <polygon points="95,99 112,99 95,105" fill={c(11)} stroke={NAVY} strokeWidth="0.8" />
        </>
      );
    }
  },
  {
    ...
    sections:[
      {id:1,label:"Sky",cx:30,cy:30},{id:2,label:"Grass",cx:140,cy:265},{id:3,label:"Body",cx:140,cy:165},
      {id:4,label:"Wing",cx:160,cy:155},{id:5,label:"Head",cx:130,cy:92},{id:6,label:"Forehead",cx:128,cy:78},
      {id:7,label:"Tail",cx:162,cy:198},{id:8,label:"Chest",cx:120,cy:158},{id:9,label:"Wing Tip",cx:168,cy:175},
      {id:10,label:"Eye",cx:138,cy:88},{id:11,label:"Eye Dot",cx:138,cy:88},{id:12,label:"Beak Top",cx:120,cy:95},
      {id:13,label:"Beak Bot",cx:120,cy:103},{id:14,label:"Left Leg",cx:126,cy:220},{id:15,label:"Right Leg",cx:154,cy:220},
    ],
    render(c) {
      return (
        <>
          <rect x="0" y="0" width="280" height="280" fill={c(1)} />
          <ellipse cx="140" cy="270" rx="140" ry="18" fill={c(2)} /><rect x="0" y="258" width="280" height="22" fill={c(2)} />
          <line x1="126" y1="210" x2="118" y2="235" stroke={c(14)} strokeWidth="5" strokeLinecap="round" />
          <line x1="118" y1="235" x2="106" y2="240" stroke={c(14)} strokeWidth="3" strokeLinecap="round" />
          <line x1="118" y1="235" x2="112" y2="244" stroke={c(14)} strokeWidth="3" strokeLinecap="round" />
          <line x1="154" y1="210" x2="162" y2="235" stroke={c(15)} strokeWidth="5" strokeLinecap="round" />
          <line x1="162" y1="235" x2="174" y2="240" stroke={c(15)} strokeWidth="3" strokeLinecap="round" />
          <line x1="162" y1="235" x2="168" y2="244" stroke={c(15)} strokeWidth="3" strokeLinecap="round" />
          <ellipse cx="162" cy="200" rx="14" ry="36" fill={c(7)} stroke={NAVY} strokeWidth="1" transform="rotate(12,162,200)" />
          <ellipse cx="166" cy="178" rx="22" ry="32" fill={c(9)} stroke={NAVY} strokeWidth="1" transform="rotate(8,166,178)" />
          <ellipse cx="140" cy="168" rx="40" ry="52" fill={c(3)} stroke={NAVY} strokeWidth="1.5" />
          <ellipse cx="158" cy="158" rx="30" ry="44" fill={c(4)} stroke={NAVY} strokeWidth="1" transform="rotate(8,158,158)" />
          <ellipse cx="118" cy="162" rx="24" ry="32" fill={c(8)} stroke={NAVY} strokeWidth="1.2" />
          <circle cx="130" cy="94" r="36" fill={c(5)} stroke={NAVY} strokeWidth="1.5" />
          <ellipse cx="128" cy="78" rx="18" ry="12" fill={c(6)} stroke={NAVY} strokeWidth="1" />
          <circle cx="138" cy="89" r="9" fill={c(10)} stroke={NAVY} strokeWidth="1" />
          <circle cx="138" cy="89" r="4" fill={c(11)} />
          <circle cx="140" cy="87" r="2" fill="white" />
          <polygon points="104,91 122,88 104,97" fill={c(12)} stroke={NAVY} strokeWidth="0.8" />
          <polygon points="104,97 122,97 104,105" fill={c(13)} stroke={NAVY} strokeWidth="0.8" />
        </>
      );
    }
  },
  {
    ...
    sections:[
      {id:1,label:"Sky",cx:30,cy:30},{id:2,label:"Branch",cx:140,cy:240},{id:3,label:"Body",cx:140,cy:165},
      {id:4,label:"Wings",cx:140,cy:160},{id:5,label:"Chest",cx:140,cy:170},{id:6,label:"Face Disc",cx:140,cy:110},
      {id:7,label:"Left Eye",cx:120,cy:105},{id:8,label:"Left Iris",cx:120,cy:105},{id:9,label:"L Pupil",cx:120,cy:105},
      {id:10,label:"Right Eye",cx:160,cy:105},{id:11,label:"Right Iris",cx:160,cy:105},{id:12,label:"R Pupil",cx:160,cy:105},
      {id:13,label:"Beak",cx:140,cy:122},{id:14,label:"Ear Tufts",cx:140,cy:80},
    ],
    render(c) {
      return (
        <>
          <rect x="0" y="0" width="280" height="280" fill={c(1)} />
          <rect x="60" y="228" width="160" height="28" rx="14" fill="#78350f" stroke={NAVY} strokeWidth="1" />
          <ellipse cx="140" cy="228" rx="80" ry="14" fill="#92400e" />
          <ellipse cx="168" cy="185" rx="36" ry="56" fill={c(4)} stroke={NAVY} strokeWidth="1.5" />
          ...
          <circle cx="120" cy="106" r="12" fill={c(8)} />
          <circle cx="160" cy="106" r="12" fill={c(11)} />
          <circle cx="120" cy="106" r="6" fill={c(9)} />
          <circle cx="160" cy="106" r="6" fill={c(12)} />
          <circle cx="123" cy="103" r="2.5" fill="white" /><circle cx="163" cy="103" r="2.5" fill="white" />
          <polygon points="132,118 140,128 148,118" fill={c(13)} stroke={NAVY} strokeWidth="0.8" />
          <polygon points="124,84 140,68 156,84 148,88 140,76 132,88" fill={c(14)} stroke={NAVY} strokeWidth="1" />
        </>
      );
    }
  },
  {
    ...
    sections:[
      {id:1,label:"Sky",cx:30,cy:30},{id:2,label:"Grass",cx:140,cy:258},{id:3,label:"Roof Left",cx:100,cy:115},
      {id:4,label:"Roof Right",cx:180,cy:115},{id:5,label:"Wall Left",cx:100,cy:185},{id:6,label:"Wall Right",cx:180,cy:185},
      {id:7,label:"Door",cx:140,cy:200},{id:8,label:"Window TL",cx:100,cy:168},{id:9,label:"Window TR",cx:180,cy:168},
      {id:10,label:"Win BL",cx:100,cy:195},{id:11,label:"Win BR",cx:180,cy:195},{id:12,label:"Garden",cx:140,cy:240},
      {id:13,label:"Chimney",cx:172,cy:95},{id:14,label:"Path",cx:140,cy:242},
    ],
    render(c) {
      return (
        <>
          <rect x="0" y="0" width="280" height="280" fill={c(1)} />
          <ellipse cx="140" cy="260" rx="140" ry="22" fill={c(2)} /><rect x="0" y="248" width="280" height="32" fill={c(2)} />
          <rect x="62" y="140" width="156" height="110" rx="4" fill={c(5)} stroke={NAVY} strokeWidth="1.5" />
          <rect x="62" y="140" width="78" height="110" fill={c(5)} />
          <rect x="140" y="140" width="78" height="110" fill={c(6)} />
          <polygon points="50,148 140,80 230,148" fill={c(3)} stroke={NAVY} strokeWidth="1.5" />
          <polygon points="140,80 230,148 230,148" fill={c(4)} stroke={NAVY} strokeWidth="1.5" />
          <rect x="160" y="76" width="18" height="40" rx="4" fill={c(13)} stroke={NAVY} strokeWidth="1" />
          <rect x="118" y="178" width="44" height="72" rx="4" fill={c(7)} stroke={NAVY} strokeWidth="1.2" />
          <circle cx="138" cy="214" r="3" fill="#eab308" />
          <rect x="74" y="158" width="34" height="26" rx="3" fill={c(8)} stroke={NAVY} strokeWidth="1" />
          <rect x="172" y="158" width="34" height="26" rx="3" fill={c(9)} stroke={NAVY} strokeWidth="1" />
          <line x1="91" y1="158" x2="91" y2="184" stroke={NAVY} strokeWidth="1" />
          <line x1="74" y1="171" x2="108" y2="171" stroke={NAVY} strokeWidth="1" />
          <line x1="189" y1="158" x2="189" y2="184" stroke={NAVY} strokeWidth="1" />
          <line x1="172" y1="171" x2="206" y2="171" stroke={NAVY} strokeWidth="1" />
          <ellipse cx="80" cy="248" rx="18" ry="8" fill={c(12)} />
          <ellipse cx="200" cy="248" rx="18" ry="8" fill={c(12)} />
          <rect x="125" y="230" width="30" height="20" rx="2" fill={c(14)} />
        </>
      );
    }
  },
  {
    ...
    sections:[
      {id:1,label:"Sky",cx:30,cy:30},{id:2,label:"Grass",cx:140,cy:262},{id:3,label:"Roof",cx:140,cy:102},
      {id:4,label:"Attic",cx:140,cy:130},{id:5,label:"Wall Left",cx:100,cy:188},{id:6,label:"Wall Right",cx:180,cy:188},
      {id:7,label:"Door",cx:140,cy:208},{id:8,label:"Win TL",cx:92,cy:162},{id:9,label:"Win TR",cx:188,cy:162},
      {id:10,label:"Win BL",cx:92,cy:195},{id:11,label:"Win BR",cx:188,cy:195},{id:12,label:"Chimney",cx:96,cy:90},
      {id:13,label:"Roof 2",cx:140,cy:108},{id:14,label:"Step",cx:140,cy:236},
    ],
    render(c) {
      return (
        <>
          <rect x="0" y="0" width="280" height="280" fill={c(1)} />
          <ellipse cx="140" cy="264" rx="140" ry="18" fill={c(2)} /><rect x="0" y="252" width="280" height="28" fill={c(2)} />
          <rect x="68" y="142" width="144" height="112" rx="3" fill={c(5)} stroke={NAVY} strokeWidth="1.5" />
          <rect x="68" y="142" width="72" height="112" fill={c(5)} />
          <rect x="140" y="142" width="72" height="112" fill={c(6)} />
          <polygon points="55,150 140,75 225,150" fill={c(3)} stroke={NAVY} strokeWidth="1.5" />
          <rect x="88" y="68" width="16" height="42" rx="3" fill={c(12)} stroke={NAVY} strokeWidth="1" />
          <rect x="78" y="144" width="124" height="22" fill={c(4)} stroke={NAVY} strokeWidth="1" />
          <rect x="115" y="180" width="50" height="74" rx="3" fill={c(7)} stroke={NAVY} strokeWidth="1.2" />
          <circle cx="133" cy="218" r="3" fill="#eab308" />
          <rect x="75" y="150" width="32" height="24" rx="2" fill={c(8)} stroke={NAVY} strokeWidth="1" />
          <rect x="173" y="150" width="32" height="24" rx="2" fill={c(9)} stroke={NAVY} strokeWidth="1" />
          <rect x="75" y="182" width="32" height="24" rx="2" fill={c(10)} stroke={NAVY} strokeWidth="1" />
          <rect x="173" y="182" width="32" height="24" rx="2" fill={c(11)} stroke={NAVY} strokeWidth="1" />
          <line x1="91" y1="150" x2="91" y2="174" stroke={NAVY} strokeWidth="0.8" />
          <line x1="75" y1="162" x2="107" y2="162" stroke={NAVY} strokeWidth="0.8" />
          <line x1="189" y1="150" x2="189" y2="174" stroke={NAVY} strokeWidth="0.8" />
          <line x1="173" y1="162" x2="205" y2="162" stroke={NAVY} strokeWidth="0.8" />
          <rect x="120" y="244" width="40" height="10" rx="3" fill={c(14)} />
        </>
      );
    }
  },
  {
    ...
    sections:[
      {id:1,label:"Sky",cx:30,cy:30},{id:2,label:"Grass",cx:140,cy:262},{id:3,label:"Roof",cx:140,cy:100},
      {id:4,label:"Wall",cx:140,cy:185},{id:5,label:"Left Wall",cx:78,cy:185},{id:6,label:"Loft Door",cx:140,cy:148},
      {id:7,label:"Main Door",cx:140,cy:208},{id:8,label:"Win Left",cx:84,cy:178},{id:9,label:"Win Right",cx:196,cy:178},
      {id:10,label:"Siding",cx:140,cy:190},{id:11,label:"Right Wall",cx:202,cy:185},{id:12,label:"Roof Peak",cx:140,cy:85},
      {id:13,label:"Loft Frame",cx:140,cy:148},{id:14,label:"Path",cx:140,cy:245},
    ],
    render(c) {
      return (
        <>
          <rect x="0" y="0" width="280" height="280" fill={c(1)} />
          <ellipse cx="140" cy="264" rx="140" ry="18" fill={c(2)} /><rect x="0" y="252" width="280" height="28" fill={c(2)} />
          <rect x="55" y="140" width="170" height="115" rx="3" fill={c(4)} stroke={NAVY} strokeWidth="1.5" />
          <rect x="55" y="140" width="34" height="115" fill={c(5)} />
          <rect x="191" y="140" width="34" height="115" fill={c(11)} />
          <line x1="55" y1="155" x2="225" y2="155" stroke="rgba(0,0,0,0.15)" strokeWidth="6" />
          <line x1="55" y1="171" x2="225" y2="171" stroke="rgba(0,0,0,0.15)" strokeWidth="6" />
          ...
          <rect x="112" y="178" width="56" height="77" rx="3" fill={c(7)} stroke={NAVY} strokeWidth="1.2" />
          <rect x="68" y="165" width="30" height="22" rx="2" fill={c(8)} stroke={NAVY} strokeWidth="1" />
          <rect x="182" y="165" width="30" height="22" rx="2" fill={c(9)} stroke={NAVY} strokeWidth="1" />
          <line x1="83" y1="165" x2="83" y2="187" stroke={NAVY} strokeWidth="0.8" />
          <line x1="68" y1="176" x2="98" y2="176" stroke={NAVY} strokeWidth="0.8" />
          <line x1="197" y1="165" x2="197" y2="187" stroke={NAVY} strokeWidth="0.8" />
          <line x1="182" y1="176" x2="212" y2="176" stroke={NAVY} strokeWidth="0.8" />
          <rect x="125" y="242" width="30" height="13" rx="3" fill={c(14)} />
        </>
      );
    }
  },
...
export default function StrokeWise() {
  ...
  function genMath(){
    ...
    setMathQ({a,b,op,answer:ans,options:[ans,Math.abs(w1)||1,Math.abs(w2)||2].sort(()=>Math.random()-0.5)});
    ...
    return(
      <div style={{minHeight:"100vh",background:BG,fontFamily:"Georgia,serif",padding:"50px 20px 80px"}}>
        ...
        <div style={{...card({marginTop:24,background:"#f0f9ff",border:"1px solid rgba(42,127,138,0.2)"})}}>
          ...
          <div style={{fontSize:12,color:"#3a4a5a",lineHeight:1.6}}>This information is for educational purposes only. Always follow the advice of your medical team.</div>
        </div>
        ...
        {modal&&(
          <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",backdropFilter:"blur(8px)",display:"flex",alignItems:"center",justifyContent:"center",padding:"12px",zIndex:200}} onClick={()=>setModal(false)}>
            <div style={{background:"linear-gradient(160deg,#fff,#f8f4ef)",borderRadius:26,padding:"24px 20px 28px",width:"100%",maxWidth:480,border:"1px solid rgba(30,58,95,0.1)",boxSizing:"border-box",height:"calc(100vh - 24px)",overflowY:"auto"}} onClick={e=>e.stopPropagation()}>
              ...
              <div style={{marginBottom:10}}><input type="text" inputMode="email" autoComplete="email" autoCapitalize="none" autoCorrect="off" placeholder="Enter your email address" value={checkoutEmail} onChange={e=>{setCheckoutEmail(e.target.value);setCheckoutError("");}} style={{width:"100%",background:"#fff",border:`2px solid ${checkoutError?"#ef4444":TEAL}`,borderRadius:12,padding:"12px 14px",fontSize:16,outline:"none",fontFamily:"Georgia,serif",boxSizing:"border-box",marginBottom:6,WebkitAppearance:"none",color:"#1e3a5f"}}/>{checkoutError&&<div style={{fontSize:11,color:"#ef4444",marginBottom:4}}>{checkoutError}</div>}</div><button onClick={async()=>{if(!checkoutEmail||!checkoutEmail.includes("@")){setCheckoutError("Please enter a valid email");return;}setCheckoutLoading(true);setCheckoutError("");const priceId=selPlan==="Annual"?"price_1TYzUiHvzoFiGNgHVMXYnquJ":"price_1TYzShHvzoFiGNgHgUBKZEU3";try{const res=await fetch("/api/create-checkout",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({priceId,email:checkoutEmail})});const data=await res.json();if(data.url){window.location.href=data.url;}else{setCheckoutError("Something went wrong. Please try again.");setCheckoutLoading(false);}}catch(e){setCheckoutError("Something went wrong. Please try again.");setCheckoutLoading(false);}}} disabled={checkoutLoading} style={{width:"100%",background:checkoutLoading?"#ccc":`linear-gradient(135deg,${WARM},${GOLD})`,border:"none",borderRadius:16,padding:"14px",color:"#fff",fontSize:14,fontWeight:700,cursor:checkoutLoading?"not-allowed":"pointer",marginBottom:10}}>{checkoutLoading?"Setting up your trial…":"Start Free 7-Day Trial"}</button>
              <button onClick={()=>setModal(false)} style={{width:"100%",background:"rgba(30,58,95,0.05)",border:"1px solid rgba(30,58,95,0.08)",borderRadius:16,padding:"11px",color:"#5a6a7a",fontSize:13,cursor:"pointer"}}>Maybe later</button><button onClick={async()=>{const email=checkoutEmail||prompt("Enter the email you used to subscribe:");if(!email)return;try{const res=await fetch("/api/check-subscription",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email})});const data=await res.json();if(data.isPremium){setPremium(true);setModal(false);alert("Welcome back! Premium unlocked ✓");}else{alert("No active subscription found for that email.");}}catch(e){alert("Something went wrong. Please try again.");}}} style={{width:"100%",background:"transparent",border:"none",color:"#9aabb8",fontSize:12,cursor:"pointer",marginTop:6,textDecoration:"underline"}}>Already subscribed? Restore access</button>
